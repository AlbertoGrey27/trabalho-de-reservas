...
public class Area {
    ...
    private ArrayList<especies> especies = new ArrayList<>();
    ...
    public ArrayList<org.example.especies> getEspecies() {
        return especies;
    }

    public void setEspecies(ArrayList<org.example.especies> especies) {
